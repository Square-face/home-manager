let
  ...
  frank = "ssh-rsa ";

  systems = [ flappy shrexbox frank ];
...
in {
  "frank/syncthing-key.age".publicKeys = yubikeys ++ [frank];
  "frank/syncthing-cert.age".publicKeys = yubikeys ++ [frank];
